        ...
        >
          <InboxNotificationList>
            {unreadNotifications.length <= 0 && (
              <p className="py-2 text-center text-[#333333] ">No notifications yet</p>
            )}
            ...
            {unreadNotifications.length > 0 &&
              unreadNotifications.map((inboxNotification: any) => (
                <InboxNotification
                  ...
                  href={`/docs/${inboxNotification.roomId}`}
                  showActions={false}
                  kinds={{
                    thread: (props) => (
                    ...
                    textMention: (props) => {
                      return <InboxNotification.TextMention {...props} showRoomName={false} />;
                    },
